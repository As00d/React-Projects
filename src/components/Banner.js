const Banner = () => {
  return (
    <section className="flex flex-col md:flex-row items-center justify-center px-6 md:px-10 py-20 gap-6 animate-fadeIn">
      <div className="flex flex-col flex-1 justify-center max-w-xl">
        ...
        <a
          ...
          className="bg-[#60DBFB] p-3 max-w-48 rounded-md m-2 font-medium inline-block transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110"
        >
          LINKEDIN PROFILE
        </a>
      </div>
